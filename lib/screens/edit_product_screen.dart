...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies() {
    if(_isInit){
      String productId =  ModalRoute.of(context)?.settings.arguments.toString() as String;
      if(productId != 'null'){
  ...
  void _updateImageUrl() {
    if (!_imageUrlFocusNode.hasFocus || (_imageUrlController.text.isEmpty) || (!_imageUrlController.text.startsWith('http') && !_imageUrlController.text.startsWith('https'))) {
      setState(() {});
    }
  }
